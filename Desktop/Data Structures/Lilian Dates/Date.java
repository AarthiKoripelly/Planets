public class Date
{
  ...
  public boolean valid(){
      ...
      else if (getDay() > 0 && getDay() <= 31 && (getMonth() == 3 || getMonth() == 1 || getMonth() == 5 || getMonth() == 7 || getMonth() == 8 || getMonth() == 10 || getMonth() == 12)){
          return true; 
        }
      else if (getDay() > 0 && getDay() <= 30 && (getMonth() == 4 || getMonth() == 6 || getMonth() == 9 || getMonth() == 11)){
          return true; 
        }
       else if (getDay() > 0 && getDay() <= 28 && getMonth() == 2 && getYear()%4 != 0){
           return true;
       }
       else if (getDay() > 0 && getDay() <= 29 && getMonth() == 2 && getYear()%4 == 0 && getYear() != 1900){
           return true;
       }
